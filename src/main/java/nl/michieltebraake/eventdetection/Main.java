...
public class Main {
    ...
    public static void main(String[] args) {
        Main main = new Main();
        main.buildReferenceData();
        main.findEvents(0, 0);
    }

    public void setBrakingEvents(List<EventTime> brakingEventTimes, String dataFile) {
    ...
    public void setHardBrakingEvents(List<EventTime> hardBrakingEventTimes, String dataFile) {
    ...
    public EventComparison compareWithReferences(TimeSeries series) {
        double smallestDistance = 10000;
